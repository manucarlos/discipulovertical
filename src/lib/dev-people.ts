import type { MemberEvolution } from "./evolution";
...
const NO_EVOLUTION: MemberEvolution = {
  cyclesCompleted: 0,
  cyclesTotal: 4,
  cycleFreqPerWeek: 0,
  groupsInProgress: 0,
  groupsCompleted: 0,
  groupLessonsCompleted: 0,
  groupLessonsStarted: 0,
  groupFreqPerWeek: 0,
  lastLoginAt: null,
};
...
export const DEV_PEOPLE: PersonRow[] = [
  row("00000000-0000-4000-8000-000000000001", "Ana Souza", "in_progress", {
    completedLessons: 3,
    startedLessons: 4,
    lastActivityAt: at(1),
    createdAt: at(12),
    evolution: { ...NO_EVOLUTION, cyclesCompleted: 1, cycleFreqPerWeek: 1.5, groupsInProgress: 1, groupLessonsCompleted: 2, groupLessonsStarted: 3, groupFreqPerWeek: 0.8, lastLoginAt: at(0) },
  }),
  row("00000000-0000-4000-8000-000000000002", "Bia Lima", "stalled", { completedLessons: 1, startedLessons: 1, lastActivityAt: at(23), createdAt: at(40), evolution: { ...NO_EVOLUTION, lastLoginAt: at(20) } }),
  row("00000000-0000-4000-8000-000000000003", "Caio Nunes", "completed", {
    completedLessons: 8,
    startedLessons: 8,
    lastActivityAt: at(5),
    createdAt: at(60),
    evolution: { ...NO_EVOLUTION, cyclesCompleted: 2, groupsCompleted: 1, groupLessonsCompleted: 7, groupLessonsStarted: 7, lastLoginAt: at(5) },
  }),
  ...
  row("00000000-0000-4000-8000-000000000007", "Pastor Paulo", "completed", { role: "admin", completedLessons: 8, startedLessons: 8, lastActivityAt: at(0), evolution: { ...NO_EVOLUTION, lastLoginAt: at(0) } }),
];
