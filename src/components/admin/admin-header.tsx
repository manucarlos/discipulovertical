        ...
        <nav aria-label="Painel de conteúdo" className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm">
          ...
          {role === "admin" && (
            <>
              ...
              <Link href="/admin/grupos" className="inline-flex min-h-11 items-center px-1.5 hover:underline">
                Grupos
              </Link>
              ...
              <Link href="/admin/marca" className="inline-flex min-h-11 items-center px-1.5 hover:underline">
                Marca
              </Link>
              <Link href="/admin/igreja" className="inline-flex min-h-11 items-center px-1.5 hover:underline">
                Nossa Igreja
              </Link>
              <Link href="/admin/configuracoes" className="inline-flex min-h-11 items-center px-1.5 hover:underline">
                Configurações
              </Link>
            </>
          )}
