...
| 6 | Confirmar as **cores oficiais** | Igreja/comunicação | Já feito com base no logotipo: o site usa o laranja (`#c14602`) e o preto do logotipo. Se a comunicação tiver outras cores oficiais, a troca é em um arquivo só: [MARCA.md](MARCA.md) |
